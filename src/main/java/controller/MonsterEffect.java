...
//        }
    ...
    public static void commandKnight(String player1, String rival, int ownAddress) {//kamel3
        int counter = 0;
    ...
    public static void yomiShip(String rival, int rivalsAddress) {//kamel3
    ...
    public static void gateGuardian(int victim1Address, int victim2Address, int victim3Address, String rival) {//kamel3
...
//    }
    ...
    public static void marshmallon(String rivalName, String player1, int ownAddress) {//kamel3
    ...
    public static void beastKingBarbaros(String rival, String player1, String kindOfSummon, int victim1Address,
                                         int victim2Address, int victim3Address, int ownAddress) {//kamel3
    ...
    public static void theCalculator(String player1, int ownAddress) {//kamel3
    ...
    public static void mirageDragon(String player1, int ownAddress, String rival) {//kamel3
    ...
    public static void exploderDragon(int addressOfAttacker, String rival) {//kamel3
