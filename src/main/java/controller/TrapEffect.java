...
public class TrapEffect {
    ...
    public static boolean ringOfDefenseEffect(String rival, String onlineUser) {
        ...
        for (Integer key : keys) {
            if (SpellTrapZoneCard.getSpellCardByAddress(key, rival).getSpellTrapName().equals("Ring of defense") && SpellTrapZoneCard.getSpellCardByAddress(key, rival).getMode().equals("O")) {
                counter++;
            }
        }
        ...
        for (Integer key : keys) {
            if (SpellTrapZoneCard.getSpellCardByAddress(key, onlineUser).getSpellTrapName().equals("Ring of defense") && SpellTrapZoneCard.getSpellCardByAddress(key, onlineUser).getMode().equals("O")) {
                counter++;
            }
        }
        return counter != 0;
