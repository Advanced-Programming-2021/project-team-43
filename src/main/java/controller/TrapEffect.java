...
public class TrapEffect {
    ...
    public static void mirrorForce(String rival) {//kamel3
    ...
    public static void magicJammer(String player1, int activateCardAddress, boolean activateMine, String rival) {//kamel3
        if (activateMine) {
