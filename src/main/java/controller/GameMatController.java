...
public class GameMatController {
    ...
    public static void showGameBoard() {
        ...
        String[] rivalSpellsMode = SpellTrapZoneCard.getAllSpellsMode(rivalUser);
        for (int i = 4; i > -1; i--)
        ...
        System.out.println("");
        String[] ownSpellsMode = SpellTrapZoneCard.getAllSpellsMode(onlineUser);
        for (int i = 0; i < 5; i++)
            System.out.print("  " + ownSpellsMode[i]);
        System.out.println("");
        GameMatView.showInput("                         " + String.valueOf(Player.getPlayerByName(onlineUser).getNumberOfMainDeckCards()));
